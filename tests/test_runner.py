...
def test_run_server_calls_async_implementation(mock_asyncio_run, temp_config_file):
...
@patch("automcp.runner.asyncio.run")
def test_run_server_handles_keyboard_interrupt(mock_asyncio_run, temp_config_file, capsys):
...
@patch("automcp.runner.asyncio.run")
def test_run_server_propagates_other_exceptions(mock_asyncio_run, temp_config_file):
...
async def test_run_server_async_loads_config(mock_server_cls, mock_load_config, temp_config_file):
    ...
    mock_server_cls.assert_called_once_with("test-group", mock_config, timeout=30.0)


@pytest.mark.asyncio
@patch("automcp.runner.load_config")
@patch("automcp.runner.AutoMCPServer")
async def test_run_server_async_starts_server(mock_server_cls, mock_load_config, temp_config_file):
...
@patch("automcp.runner.load_config")
@patch("automcp.runner.AutoMCPServer")
async def test_run_server_async_stops_server_on_exit(mock_server_cls, mock_load_config, temp_config_file):
...
@patch("automcp.runner.load_config")
@patch("automcp.runner.AutoMCPServer")
async def test_run_server_async_handles_server_exception(mock_server_cls, mock_load_config, temp_config_file):
